...
const copy = {
  ar: {
    ...
    overviewBody: `تأسس مكتب آل حراز عام ${siteConfig.foundingYear} على يد ${siteConfig.founderAr}، ويضم اليوم فريقًا من ${siteConfig.teamSize} محاميًا يقدمون خدمات المحاماة والاستشارات القانونية للأفراد والشركات في مختلف فروع القانون في جميع أنحاء جمهورية مصر العربية.`,
    founderHeading: 'المؤسس',
    founderBody: `أسس ${siteConfig.founderAr} المكتب عام ${siteConfig.foundingYear}.`,
  ...
  en: {
    ...
    overviewBody: `Founded in ${siteConfig.foundingYear} by ${siteConfig.founderEn}, Al Harraz Law Firm is a full-service Egyptian law firm with a team of ${siteConfig.teamSize} lawyers providing legal representation and advisory services to individuals and businesses across Egypt.`,
    founderHeading: 'Founder',
    founderBody: `${siteConfig.founderEn} founded the firm in ${siteConfig.foundingYear}.`,
