...
const copy = {
  ar: {
    ...
    items: [
      { title: 'خبرة ممتدة منذ 1983', body: 'ممارسة قانونية مستمرة منذ أكثر من أربعة عقود.' },
  ...
  en: {
    ...
    items: [
      { title: 'Experience Since 1983', body: 'Continuous legal practice for over four decades.' },
