...
| `practice-areas` | Service pages (21 seeded: Civil Law, Criminal Law, Litigation, Corporate/Commercial, Company Formation, Contracts, Arbitration, Maritime/Shipping/Port, Customs/Import-Export, Employment, Real Estate, Family Law, Inheritance & Estates, Administrative, Debt Recovery, Intellectual Property, Tax, Banking & Finance, Insurance Disputes, Consumer Protection, General Advisory) | Yes | Seeded as **drafts** — not publicly visible until reviewed and published. Civil Law and Criminal Law are marked `featured: true` so they surface first in the homepage/index previews, per client direction — see `CONTENT_REQUIRED.md`. |
