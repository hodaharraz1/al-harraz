...
|---|---|---|---|
| محامي في دمياط | L/C | High | Home / Contact |
| مكتب محاماة في دمياط | L/C | High | Home |
...
| حجز السفن في مصر (Ship arrest) | I | Low-Medium | Insights / Maritime |
| منازعات التأمين البحري | I | Low | Insights / Maritime |
| مستندات الاستيراد والتصدير | I | Medium | Insights / Maritime |
| الميراث والأحوال الشخصية — أساسيات | I | Medium | Insights / Family |

## Method Note

Each keyword must map to exactly one primary target page (no cannibalization). Before publishing new content, check this table for an existing target; extend that page rather than creating a near-duplicate. Update this file, not just the CMS, whenever a new primary target is assigned.
